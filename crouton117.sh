...
echo "1st step complete! Please run crouton117 -X to continue!"
}
...
{
  #Downloads Xenial Chroot
  read -p "SELECTED:[BIONIC*] Do you want to proceed? (y/n) " yn
...
sudo enter-chroot
sudo apt install ssh
echo "1st step complete! Please run crouton117 -B to continue!"
}
...
{
	# Displays Version!
 echo -e "${GREEN}crouton117 v1.0.0_8${NC}"
 }
